          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-lg md:text-xl text-muted-foreground leading-relaxed mb-8 max-w-xl">
                <span className="text-foreground font-semibold">Dubai</span>, <span className="text-foreground font-semibold">DMCC</span> based <span className="text-foreground font-semibold">Billiton Diamond</span>, together with the UAE's leading tokenisation partner, has launched Dubai's first <span className="text-foreground font-semibold">VARA</span>‑regulated diamond tokenisation platform from DMCC—unlocking liquidity for manufacturers, traders, and asset owners, introducing an institutional‑grade on‑chain asset class, and positioning the diamond market for a future‑ready digital financial ecosystem.
              </p>
